...
public class ProgramaPrincipal {
	...
	public static void main(String[] args) {
		...
		/*
		 * Esse objeto realiza a leitura dos dados enviados para o teclado. Ao ser
		 * invocado fica aguardando a entrada de dados.
		 * 
		 */
		 ...
		 * ter seu comportamento invocado. x é o nome da variavél que aponta para o
		 * objeto em memória.
		 */
